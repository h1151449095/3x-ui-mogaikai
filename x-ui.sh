...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/h1151449095/3x-ui-mogaikai/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    curl -fLRo /usr/bin/x-ui https://raw.githubusercontent.com/h1151449095/3x-ui-mogaikai/main/x-ui.sh
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/h1151449095/3x-ui-mogaikai/main/install.sh)${plain}"
    echo ""
