...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/h1151449095/3x-ui-h1151449095/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    curl -fLRo /usr/bin/x-ui https://raw.githubusercontent.com/h1151449095/3x-ui-h1151449095/main/x-ui.sh
...
legacy_version() {
    ...
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/h1151449095/3x-ui-h1151449095/v$tag_version/install.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/h1151449095/3x-ui-h1151449095/main/install.sh)${plain}"
    echo ""
...
update_shell() {
    curl -fLRo /usr/bin/x-ui -z /usr/bin/x-ui https://github.com/h1151449095/3x-ui-h1151449095/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
