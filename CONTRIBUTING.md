...
```bash
git clone https://github.com/martiny8/3x-ui-mogaikai.git
cd 3x-ui
...
- Bug reports and feature requests: [GitHub Issues](https://github.com/martiny8/3x-ui-mogaikai/issues)
- General questions and ideas: [GitHub Discussions](https://github.com/martiny8/3x-ui-mogaikai/discussions)
